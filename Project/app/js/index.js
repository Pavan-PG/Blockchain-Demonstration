...
const GOVERNMENT_CHANNEL = "Government";
...
EmbarkJS.onReady(async (err) => {
    ...
    channelName.innerHTML = GOVERNMENT_CHANNEL;

    const channelSymKey = await web3.shh.generateSymKeyFromPassword(GOVERNMENT_CHANNEL);
