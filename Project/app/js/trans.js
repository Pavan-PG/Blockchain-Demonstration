...
const TRANSPORT_CHANNEL = "Transport";
...
EmbarkJS.onReady(async (err) => {
    ...
    channelName.innerHTML = TRANSPORT_CHANNEL;

    const channelSymKey = await web3.shh.generateSymKeyFromPassword(TRANSPORT_CHANNEL);
