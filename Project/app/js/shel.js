...
const SHELTER_CHANNEL = "Housing services (SHELTER)";
...
EmbarkJS.onReady(async (err) => {
    ...
    channelName.innerHTML = SHELTER_CHANNEL;

    const channelSymKey = await web3.shh.generateSymKeyFromPassword(SHELTER_CHANNEL);
